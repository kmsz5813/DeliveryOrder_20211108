...
import com.nepplus.deliveryorder_20211108.adapters.PizaaStoreAdapter
...
class PizzaStoreListFragment : Fragment() {
    ...
    lateinit var mPizzaStoreAdapter : PizaaStoreAdapter
...
//        동작 관련 코드 작성 예정
        ...
        mPizzaStoreList.add( StoreData("미스터피자","1577-0077"," https://post-phinf.pstatic.net/jAxODEyMDVfMzYg/MDAxNTQzOTYxOTA4NjM3.8gsStnhxz7eEc9zpt5nmSRZmI-Pzpl4NJvHYU-Dlgmcg.7Vpgk0lopJ5GoTav3CUDqmXi2-_67S5AXD0AGbbR6J4g.JPEG/IMG_1641.jpg?type=w1200")   )
        ...
        mPizzaStoreAdapter = PizaaStoreAdapter(requireContext(),R.layout.store_list_item,mPizzaStoreList)
